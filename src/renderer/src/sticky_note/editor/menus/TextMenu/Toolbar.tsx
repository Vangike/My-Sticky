...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ active, className, activeClassname, disabled, children, ...rest }, ref) => {
    const buttonClassName = cn(
      'flex group items-center justify-center border border-transparent text-sm font-semibold rounded disabled:opacity-50 whitespace-nowrap',

      cn(
        'bg-transparent border-transparent text-neutral-500 dark:text-neutral-400',
        !disabled &&
          !active &&
          'hover:bg-black/5 hover:text-neutral-800 active:bg-black/10 active:text-neutral-800 dark:hover:bg-white/10 dark:hover:text-neutral-300 dark:active:text-neutral-200',
        active &&
